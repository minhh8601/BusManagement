...
public class View {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    BusManagement[] result = controllerUltility.findByName(managerments, key);
                    showBMInfo(result);
                    break;
    ...
    private static BusManagement[] update(ControllerUltility controllerUltility,
                                                  BusManagement[] managerments,
                                                  DataUlitility dataUlitility) {
        Driver[] drivers = readDriverInfo(dataUlitility, "DRIVER.DAT");
        BusRoute[] busRoutes = readRouteInfo(dataUlitility, "ROUTE.DAT");
        return controllerUltility.updateBMInfo(managerments, drivers, busRoutes);
    }
